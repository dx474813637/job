...
const mySwiper = new Swiper("#headerSwiper .swiper-container", {
	...
	on: { 
		slideChangeTransitionStart: function () {
			...
			const tarDom = $('#headerSwiper .swiper-slide.swiper-slide-active .swiper-content')
...
const joberSwiper = new Swiper("#joberSwiper", {
	...
	on: { 
		slideChangeTransitionStart: function () {
			// console.log('Start',this.activeIndex);//切换结束时，告诉我现在是第几个slide
			const tarDom = $('#joberSwiper .swiper-slide.swiper-slide-active .swiper-content')
...
$('#searchBtn').on('click', function () {
	...
	location.href = 'searchRes.html?kw=' + encodeURIComponent($('#searchInp').val().trim())
})
